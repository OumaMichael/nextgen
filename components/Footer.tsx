        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/browse-cuisines" className="text-gray-400 hover:text-white transition-colors text-lg">
                  Browse Cuisines
                </Link>
              </li>
              <li>
          ...
          {/* Restaurant Partners */}
          <div>
            <h4 className="text-xl font-semibold mb-4 text-purple-400">Our Partners</h4>
            <ul className="space-y-3">
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-xl font-semibold mb-4 text-purple-400">Contact Us</h4>
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                <MapPin className="w-5 h-5 text-purple-400" />
                <span className="text-gray-400 text-lg">NextGen Mall, Level 2</span>
              </div>
              <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400 text-lg">info@nextgenfoodcourt.com</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-lg">
              © 2024 NextGen Mall Food Court. All rights reserved.
            </p>
